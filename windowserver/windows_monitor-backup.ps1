...
$nameserver = 'ev-charger-srv02'

$mess = "servser name : " + $nameserver + " `n IP : 10.101.1.36 `n CPU : " + $cpu + " % " + " `n Mem Available : " + $mem + " MB " + " `n Disk C : " + $resout_driveC + " GB " + " `n Disk D : 0 GB " + " `n Alert : Full log "
